...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        echo "<script>alert('Username already exists. Please choose a different username.'); window.location.href = 'admindashboard.php';</script>";
    } else {
        ...
        if ($conn->query($sql) === TRUE) {  
            echo "<script>alert('User has been Registered'); window.location.href = 'admindashboard.php';</script>";
        } else {
